...
;;;; File missy1.lisp: Basic version of the missy program
...
(defun missy ()
  ...
  (loop
    (print 'missy>)
    (write (flatten (use-missy-rules (read))) :pretty t)))
...
;;;missy> (hello there)
;;;(HOW DO YOU DO. PLEASE STATE YOUR PROBLEM.) 
;;;missy> (i want to test this program)
;;;(WHAT WOULD IT MEAN IF YOU GOT TO TEST THIS PROGRAM) 
;;;missy> (i could see if it works)
;;;(DO YOU REALLY THINK ITS LIKELY THAT IT WORKS)
;;;missy> (no not really)
;;;(ARE YOU SAYING "NO" JUST TO BE NEGATIVE?) 
;;;missy> (no)
;;;(ARE YOU SAYING "NO" JUST TO BE NEGATIVE?) 
;;;missy> (forget it-- i was wondering how general the program is)
;;;(WHY DO YOU TELL ME YOU WERE WONDERING HOW GENERAL THE PROGRAM IS NOW?)
;;;missy> (i felt like it)
;;;(WHAT OTHER FEELINGS DO YOU HAVE?) 
;;;missy> (i feel this is enough)
